...
<nav class="mb-4 bg-white shadow navbar navbar-expand navbar-light topbar static-top">
    ...
    <!-- Sidebar Toggle (Tsopbar) -->
    <button id="sidebarToggleTop" class="mr-3 btn btn-link d-md-none rounded-circle">
        <i class="fa fa-bars"></i>
    </button>

    <div class="my-2 mr-auto d-none d-sm-inline-block form-inline ml-md-3 my-md-0">
        <span class="navbar-greeting font-weight-bold" style="font-size: 1.1rem;">
            ...
            <span class="text-black" style="font-size: 1.1rem;">
                ...
                <span class="ml-1 badge badge-pill badge-primary">{{ ucfirst($activeSchoolYear->semester) }}</span>
            </span>
            @else
            <span class="ml-2 text-danger">None set</span>
            @endif
    ...
    <ul class="ml-auto navbar-nav">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <!-- Font Awesome User Icon instead of image -->
