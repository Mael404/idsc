...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('accountant.accountant_db') }}">
    ...
    <li class="nav-item {{ request()->is('accountant/transactions') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('accountant.transactions') }}">
